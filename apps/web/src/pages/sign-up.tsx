...
const requirements = ["8+ characters", "Email validation", "Stored securely"];
        ...
        <div className="glass-strong rounded-2xl p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-neutral-400">
              Start building production software in seconds.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-2">
              ...
              />
              {errors.fullName ? (
                <p className="text-xs text-danger-400">{errors.fullName.message}</p>
              ) : null}
            </div>
            <div className="space-y-2">
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            {requirements.map((req) => (
              <span key={req} className="flex items-center gap-1.5 text-xs text-neutral-500">
