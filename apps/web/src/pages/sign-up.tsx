    ...
    <div className="h-screen w-screen text-white flex flex-col font-sans overflow-hidden relative selection:bg-emerald-500/30">
      ...
      <header className="w-full flex items-center justify-between px-6 py-4 md:px-12 z-20 relative shrink-0">
        ...
        <div className="flex items-center gap-4">
          <Link to="/sign-in" className="px-4 py-2 text-sm text-neutral-300 hover:text-white transition-colors border border-white/10 rounded-lg hover:bg-white/5">
            Log in
          </Link>
          <Link to="/sign-up" className="px-4 py-2 text-sm text-black font-semibold bg-gradient-to-r from-[#9efdd7] to-[#4fa2fe] rounded-lg shadow-[0_0_15px_rgba(79,162,254,0.3)] hover:brightness-105 transition-all">
            Sign up
          </Link>
        </div>
      </header>
